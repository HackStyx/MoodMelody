...
export default function Dashboard() {
  ...
  return (
    <>
      ...
      <div className="px-2 sm:px-4 pb-32 flex flex-col items-center min-h-screen w-full bg-slate-50 dark:bg-slate-950 transition-colors relative overflow-hidden">
        ...
        <div className="relative z-10 w-full flex flex-col items-center">
          ...
          <div className="w-full max-w-4xl mx-auto mt-8 mb-6 relative z-10">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-slate-900 dark:bg-slate-800 text-white text-sm font-medium shadow-sm border-0 hover:bg-slate-800 dark:hover:bg-slate-700 transition-all active:scale-95"
                        style={{ fontFamily: 'var(--font-inter)' }}
                      >

...
export const ClaudeChatInput: React.FC<ClaudeChatInputProps> = ({ 
    ...
    return (
        ...
        >
            ...
            <div className={`
                !box-content flex flex-col mx-2 md:mx-0 items-stretch transition-all duration-200 relative z-10 rounded-xl cursor-text border border-slate-200 dark:border-slate-700 
                shadow-sm hover:shadow-md focus-within:shadow-md focus-within:border-slate-300 dark:focus-within:border-slate-600
                bg-white dark:bg-slate-900 font-sans antialiased
            `}>
                ...
                <div className="flex flex-col px-3 pt-3 pb-2 gap-2">
                    ...
                    <div className="relative mb-1">
                        <div className="max-h-96 w-full overflow-y-auto custom-scrollbar font-sans break-words transition-opacity duration-200 min-h-[2.5rem] pr-10">
                            <textarea
                                ref={textareaRef}
                                value={message}
                    ...
                    <div className="flex gap-2 w-full items-center justify-between">
                        {/* Left Tools - Empty for symmetry */}
                        <div className="relative flex items-center shrink min-w-0 gap-1 w-8">
                        ...
                        <div className="flex flex-row items-center min-w-0 gap-1">
                            ...
                            <div className="relative z-20">
                                <button
                                    ...
                                    disabled={!hasContent}
                                    className={`
                                        inline-flex items-center justify-center relative shrink-0 transition-all h-8 w-8 rounded-lg active:scale-95 z-20
                                        ${hasContent
                                            ? 'bg-slate-900 dark:bg-slate-800 text-white hover:bg-slate-800 dark:hover:bg-slate-700 shadow-sm hover:shadow-md'

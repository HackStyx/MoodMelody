...
export function Features() {
    return (
        <section className="relative py-16 md:py-32 dark:bg-transparent [background:radial-gradient(125%_125%_at_50%_100%,transparent_0%,var(--background)_75%)]">
            {/* ShootingStars background for dark mode */}
            ...
            <div className="mx-auto max-w-3xl lg:max-w-5xl px-6 relative z-10">
                <div className="mb-8 flex justify-center">
                    <SparklesText text="Why MoodMelody?" className="text-4xl md:text-5xl lg:text-6xl text-center" />
                </div>
                    ...
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
                            <CardContent className="relative m-auto size-fit pt-6">
                                ...
                                <h2 className="mt-6 text-center text-3xl font-semibold">Personalized</h2>
                                <p className="mt-1 text-center text-sm text-muted-foreground">Your mood, your music</p>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                ...
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="group-hover:text-secondary-950 text-2xl font-bold transition dark:text-white">Private & Secure</h2>
                                    <p className="text-muted-foreground text-sm">Emotionally Yours, Privately</p>
                                    <p className="text-muted-foreground text-sm -mt-1">No ads No leaks Your data</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                <div className="pt-6 lg:px-6 flex justify-center">
                                    {/* Emotion Detection Graph with Emoji Faces */}
                                    <svg width="180" height="80" viewBox="0 0 180 80" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        {/* Graph line */}
                                        <polyline points="10,60 30,40 50,50 70,30 90,60 110,40 130,70 150,35 170,60" fill="none" stroke="#6366F1" strokeWidth="3" strokeLinecap="round" />
                                        {/* Emoji faces at peaks/valleys using foreignObject, adjusted y and height */}
                                        <foreignObject x="20" y="20" width="28" height="28">
                                            <span style={{fontSize: '20px', display: 'block', textAlign: 'center', lineHeight: '28px'}} role="img" aria-label="happy">😊</span>
                                        </foreignObject>
                                        <foreignObject x="60" y="10" width="28" height="28">
                                            <span style={{fontSize: '20px', display: 'block', textAlign: 'center', lineHeight: '28px'}} role="img" aria-label="neutral">😐</span>
                                        </foreignObject>
                                        <foreignObject x="80" y="50" width="28" height="28">
                                            <span style={{fontSize: '20px', display: 'block', textAlign: 'center', lineHeight: '28px'}} role="img" aria-label="sad">😢</span>
                                        </foreignObject>
                                        <foreignObject x="100" y="20" width="28" height="28">
                                            <span style={{fontSize: '20px', display: 'block', textAlign: 'center', lineHeight: '28px'}} role="img" aria-label="joy">😃</span>
                                        </foreignObject>
                                        <foreignObject x="120" y="55" width="28" height="28">
                                            <span style={{fontSize: '20px', display: 'block', textAlign: 'center', lineHeight: '28px'}} role="img" aria-label="cry">😭</span>
                                        </foreignObject>
                                        <foreignObject x="140" y="15" width="28" height="28">
                                            <span style={{fontSize: '20px', display: 'block', textAlign: 'center', lineHeight: '28px'}} role="img" aria-label="smile">🙂</span>
                                        </foreignObject>
                                    </svg>
                                </div>
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    <h2 className="text-xl font-bold transition">Real-Time Emotion Detection</h2>
                                    <p className="text-muted-foreground text-sm">Our AI understands your emotions from your interaction</p>
                                </div>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="group-hover:text-secondary-950 text-2xl font-bold text-zinc-800 transition dark:text-white">Visual Mood History</h2>
                                        <p className="text-muted-foreground text-sm">View your mood patterns over time with beautiful visualizations</p>
                                    </div>
                                </div>
                        ...
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="text-2xl font-bold transition">Connect Through Emotion </h2>
                                        <p className="text-muted-foreground text-sm">Share your mood playlists with others Because understanding each other starts with listening</p>
                                    </div>
                                </div>
                                <div className="before:bg-(--color-border) relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">Felix</span>
                                            <div className="ring-background size-7 ring-4">
                                                <img className="size-full rounded-full" src="https://avatars.githubusercontent.com/u/1426799?v=4" alt="" />
                                            </div>
                                        </div>
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            <div className="ring-background size-8 ring-4">
                                                <img className="size-full rounded-full" src="https://gazijarin.com/assets/me2.jpg" alt="" />
                                            </div>
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">gazi</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">Milo</span>
                                            <div className="ring-background size-7 ring-4">
                                                <img className="size-full rounded-full" src="https://avatars.githubusercontent.com/u/137396151?v=4" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>

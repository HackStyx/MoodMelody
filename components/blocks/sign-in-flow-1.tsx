...
export const SignInPage = ({ className }: SignInPageProps) => {
  ...
  return (
    <>
      <Dialog open={showAlreadyLoggedIn}>
        <DialogContent showCloseButton={false} className="max-w-md animate-in fade-in-0 zoom-in-95">
          <DialogHeader>
            <div className="flex flex-col items-center justify-center gap-2">
              <CheckCircle2 className="text-green-500 animate-bounce" size={48} />
              <DialogTitle className="text-2xl font-bold text-green-600 dark:text-green-400">You are already logged in!</DialogTitle>
            </div>
          ...
          <DialogFooter>
            <Button
              className="w-full mt-2 text-lg font-semibold animate-pulse"
              onClick={() => {
    ...
    <div className={cn("flex w-[100%] flex-col min-h-screen bg-black relative", className)}>
      ...
      {/* Content Layer */}
        <div className="relative z-20 flex flex-1 flex-col items-center justify-center min-h-screen px-2 sm:px-4 md:px-8">
                ...
                {step === "email" ? (
                  ...
                  >
                    <div className="space-y-1 flex justify-center">
                      <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif italic tracking-wide text-white drop-shadow-lg bg-gradient-to-r from-indigo-400 via-pink-400 to-yellow-300 bg-clip-text text-transparent whitespace-nowrap mb-2 text-center">Welcome to MoodMelody</h1>
                    </div>
                    
                    <div className="space-y-4">
                      <button
                        className="backdrop-blur-[2px] w-full flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 text-white border-2 sm:border border-white/30 rounded-full py-2 md:py-3 px-3 md:px-4 transition-colors text-sm md:text-base"
                      ...
                      {!emailSent ? (
                        ...
                        <div className="relative">
                          <input 
                            ...
                            onChange={(e) => setEmail(e.target.value)}
                              className="w-full backdrop-blur-[1px] text-white border-2 sm:border border-white/30 rounded-full py-2 md:py-3 px-3 md:px-4 focus:outline-none focus:border focus:border-white text-center text-sm md:text-base"
                            required
                          />
                          <button 
                            type="submit"
                              className="absolute right-1.5 top-1.5 text-white w-8 h-8 md:w-9 md:h-9 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 transition-colors group overflow-hidden"
                              disabled={loading}
                          >
                        ...
                        <p className="text-white text-sm mt-4">Check your email for a magic link to sign in!</p>
                      )}
                    </div>
                    ...
                    <p className="text-xs text-white pt-10">
                      By signing up, you agree to the MoodMelody <Link href="#" className="underline text-white hover:text-gray-200 transition-colors">Terms</Link>, & <Link href="#" className="underline text-white hover:text-gray-200 transition-colors">Policies</Link>.
                    </p>
                  </motion.div>
                ) : step === "code" ? (
                  <motion.div 
        ...
        <div className="absolute top-4 left-4 z-20">
          <a href="/" className="text-white bg-black/40 hover:bg-black/70 rounded-full px-3 md:px-4 py-2 text-xs md:text-sm font-medium shadow transition-colors border border-white/10">
            ← Back to Homepage
          </a>
        </div>
      </div>
